    ...
    <section className="container my-52 md:my-72">
      ...
      <div className="md:gap-4 flex flex-col">
        ...
        <div className="flex items-center gap-2 md:gap-6 mb-6 mt-6">
          ...
          <a className='duration-500 scale-75 md:scale-100 md:hover:scale-125 hover:scale-90' href='https://www.linkedin.com/in/ansar-amankos-865b7b287/'><LinkedInIcon style={{fontSize: '2.5rem'}}/></a>
